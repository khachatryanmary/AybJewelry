...
const Filter = () => {
    ...
    return (
        <div className="text-black flex w-full justify-center items-center gap-[100px] border-b border-gray-400 mb-[20px] pb-[20px]">
            <p className="font-semibold ">{t('sortBy')}:</p>
            <ul className="flex gap-[20px] font-bold justify-around items-center ">
                <li className="cursor-pointer hover:text-[gray-500]">{t('popularity')}</li>
                <li className="cursor-pointer hover:text-[gray-500]">{t('type')}</li>
                <li className="cursor-pointer hover:text-[gray-500]" onClick={openPrice}>{t('price')}</li>
                {showPriceInputs && (
                    <div>
